---
name: meimei 情绪分析小程序 MVP 方案 v29（定稿版·已敲定）
...
# meimei 情绪分析小程序 方案 v29（定稿版·已敲定）

（v29：GLM 服务协议核查完毕——免费版仅限个人学习用途，开发测试合规；
上架前必须切换付费模型，配置文件改一行即可）
...
57. GLM 服务条款核查【已完成，结论如下】：
    ...
    - 模型商用授权书仅企业用户可申请 → 三期商业化前完成主体升级（个体工商户/企业）
